...
public class GameController extends JFrame {
	...
	private void setUpFrame() {
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent we) {
				int result = JOptionPane.showConfirmDialog(GameController.this, 
						"Would you like to save your state?");
	...
	private PokemonGame setUpGame(PokemonGame theGame) {
		int result = JOptionPane.showConfirmDialog(this, "Start with previous saved state?\n"
