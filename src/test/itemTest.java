...
public class itemTest {
	...
	public void TbattleTest11(){
		...
		((TrainerBattle)b).getMyTrainer().getBackpack().addItem(new Bait("Bait", 1));
		((TrainerBattle)b).getMyTrainer().getBackpack().addItem(new Bait("Bait", 1));
		((TrainerBattle)b).getMyTrainer().getBackpack().addItem(new Bait("Bait", 1));((TrainerBattle)b).getMyTrainer().getBackpack().addItem(new Bait("Bait", 1));
	...
	public void TbattleTest12(){
		...
		((TrainerBattle)b).throwBait();
		((TrainerBattle)b).throwBait();
		((TrainerBattle)b).throwBait();((TrainerBattle)b).throwBait();
	...
	public void TbattleTest14(){
		...
		((TrainerBattle)b).throwPokeball();((TrainerBattle)b).throwPokeball();
