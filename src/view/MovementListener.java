...
public class MovementListener implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		if (e.getKeyCode() == 38) {
			...
			theGame.trainer.setImage(Direction.North);
		} else if (e.getKeyCode() == 39) {
			theGame.moveTrainer(Direction.East);
			theGame.trainer.setImage(Direction.East);
		} else if (e.getKeyCode() == 37) {
			theGame.moveTrainer(Direction.West);
			theGame.trainer.setImage(Direction.West);
		} else if (e.getKeyCode() == 40) {
			theGame.moveTrainer(Direction.South);
			theGame.trainer.setImage(Direction.South);
		}
